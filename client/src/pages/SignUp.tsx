    ...
    >
      ...
      <div className="absolute inset-0 overflow-hidden">
        <motion.div
          ...
          className="absolute top-32 left-32 w-48 h-48 bg-gradient-to-br from-neutral-200/20 to-neutral-300/20 
        ...
        <motion.div
          ...
          className="absolute bottom-32 right-32 w-64 h-64 bg-gradient-to-br from-neutral-300/20 to-neutral-400/20 
      ...
      >
        ...
        <motion.div variants={itemVariants} className="text-center mb-8">
          ...
          <p className="text-neutral-600 dark:text-neutral-400">
            Join TODOISH and start organizing your tasks
          </p>
        </motion.div>
          ...
          <form onSubmit={handleSubmit} className="space-y-6">
            ...
            >
              <input
                ...
                className="mt-1 rounded border-neutral-300 dark:border-neutral-600 text-neutral-600 
              ...
              <label className="text-sm text-neutral-600 dark:text-neutral-400">
                ...
                <a
                  ...
                  className="text-neutral-800 dark:text-neutral-200 hover:text-neutral-600 
                                      dark:hover:text-neutral-400 underline transition-colors duration-200"
                >
                  Terms of Service
                </a>{" "}
                and{" "}
        ...
        >
          <motion.div
            ...
            className="text-center p-4 rounded-lg bg-white/20 dark:bg-neutral-800/20 backdrop-blur-sm 
                       border border-white/30 dark:border-neutral-700/30"
          >
            <Shield className="w-8 h-8 text-neutral-600 dark:text-neutral-400 mx-auto mb-2" />
          ...
          <motion.div
            ...
            className="text-center p-4 rounded-lg bg-white/20 dark:bg-neutral-800/20 backdrop-blur-sm 
                       border border-white/30 dark:border-neutral-700/30"
          >
            <Zap className="w-8 h-8 text-neutral-600 dark:text-neutral-400 mx-auto mb-2" />
            <h3 className="text-sm font-medium text-neutral-700 dark:text-neutral-300">
              Fast
            </h3>
          </motion.div>
          <motion.div
            ...
            className="text-center p-4 rounded-lg bg-white/20 dark:bg-neutral-800/20 backdrop-blur-sm 
                       border border-white/30 dark:border-neutral-700/30"
          >
            <CheckCircle className="w-8 h-8 text-neutral-600 dark:text-neutral-400 mx-auto mb-2" />
            <h3 className="text-sm font-medium text-neutral-700 dark:text-neutral-300">
              Reliable
            </h3>
          </motion.div>
